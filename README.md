...
- **One-Click Local AI Setup**: "Install Gemma 4" in Settings (`Ctrl+,`) automatically installs Ollama, pulls Google's edge-optimized Gemma 4 E2B model, and configures endpoints without opening a single terminal. Includes on-demand auto-start and auto-stop to release RAM when switching to cloud providers (Gemini/OpenAI).
