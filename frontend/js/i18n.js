...
const I18N = {
  en: {
    ...
    cliWarningConfirm: "⚠️ High-risk operation detected:\n\n{reason}\n\nCommand: {cmd}\n\nAre you sure you want to execute this command?",
    ...
    gitGuideStep1Warning: "⚠️ Important: Leave 'Add a README file' and '.gitignore' UNCHECKED (keep repository empty).",
  ...
  ja: {
    ...
    cliWarningConfirm: "⚠️ リスクの高いコマンドが検出されました:\n\n【理由】{reason}\n【コマンド】{cmd}\n\nこのコマンドを実行しますか？",
    ...
    gitGuideStep1Warning: "⚠️ 重要:「Add a README file」「Add .gitignore」のチェックは必ず外して完全な空（Empty）で作成してください。",
