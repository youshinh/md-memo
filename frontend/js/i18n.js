...
const I18N = {
  en: {
    ...
    modelNamePlaceholder: "gpt-4.1-mini, gemini-flash-latest, qwen2.5:latest etc.",
  ...
  ja: {
    ...
    modelNameLabel: "モデル名 (Model):",
    modelNamePlaceholder: "gpt-4.1-mini, gemini-flash-latest, qwen2.5:latest 等",
