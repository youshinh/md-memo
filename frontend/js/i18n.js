...
const I18N = {
  en: {
    ...
    ctxPromptLLM: "Inline AI Assist... ",
    ctxConvertMermaid: "Convert Selection to Mermaid Diagram...",
    ctxMermaidToImage: "Generate Image with Gemini from Mermaid...",
  ...
  ja: {
    ...
    ctxConvertMermaid: "選択テキストをMermaid図に変換...",
    ctxMermaidToImage: "Mermaid図からGeminiで画像生成...",
