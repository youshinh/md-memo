...
const I18N = {
  en: {
    ...
    ctxPromptLLM: "Inline AI... ",
    ctxPromptLLMModal: "AI Prompt Modal... ",
    ctxAiCorrection: "AI Typo & Mistake Correction... ",
    ctxConvertMermaid: "Text to Mermaid...",
    ctxMermaidToImage: "Gemini Image...",
    ctxExportPlainText: "Export Text...",
  ...
  ja: {
    ...
    ctxReplace: "置換... ",
    ctxGotoLine: "行へ移動... ",
    ctxPromptLLM: "インラインAI... ",
    ctxPromptLLMModal: "AI指示モーダル... ",
    ctxAiCorrection: "AI入力間違い補正... ",
    ctxConvertMermaid: "Mermaid図に変換...",
    ctxMermaidToImage: "AI画像生成 (Gemini)...",
    ctxExportPlainText: "テキスト保存 (.txt)...",
