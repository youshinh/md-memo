...
Basis: app 1.6.0, source of 2026-09-21 (commit a85494c or later). `(unverified)` = not checked in this repository's source (OS behaviour or an external tool). Read `interfaces.md` first for what each surface does.
